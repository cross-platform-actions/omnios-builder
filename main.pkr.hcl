...
source "qemu" "qemu" {
  ...
  boot_steps = [
    ["1<wait1m>", "Boot Multi User"],
    ["<enter><wait5s>", "Please select a keyboard layout"],
    ["f<wait><enter><wait5s>", "Find disks, create rpool and install OmniOS"],
    ["<spacebar><enter><wait5s>", "Select disks for installation"],
    ["<enter><wait10s>", "ZFS Root Pool Configuration"],
    ["<enter><wait5s>", "Enter the system hostname"],
    ["<enter><wait>", "Please identify a location so that time zone rules can be set correctly"],
    ["y<wait2m30s>", "The following information has been given"],
